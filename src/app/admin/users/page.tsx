        ...
        <div className="px-5 pb-6">
          ...
          <div className="mt-5 pt-4 border-t" style={{ borderColor: "rgba(255,255,255,0.05)" }}>
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              {([
                { label: "Gratuit auj.", value: user.ai_free_today,    color: "#22c55e" },
                { label: "Premium auj.", value: user.ai_premium_today, color: "#a78bfa" },
                { label: "Lourd auj.",   value: user.ai_heavy_today,   color: "#f87171" },
                { label: "Total",        value: user.ai_total_alltime, color: "rgba(255,255,255,0.5)" },
