        ...
        >
          ...
          <div className="relative flex items-center justify-center" style={{ width: 120, height: 120 }}>
            ...
            <motion.div
              ...
              style={{ width: 90, height: 90, background:"var(--surface-alt)", border:"1px solid var(--border)" }}
            ...
            >
              <Mic strokeWidth={1.5} size={28} color="var(--bg)" />
            </div>
          </div>
          ...
          >
            <Sparkles strokeWidth={1.5} size={11} />
            Bientôt disponible
          </div>
